...
public class Boot {
	...
	private static boolean init() {
		...
		try {
			...
			// rsa密钥
			if (!BaseString.isEmpty(pps.getProperty("rsa.publicKey"))
					&& !BaseString.isEmpty(pps.getProperty("rsa.privateKey"))) {
	 ...
	 * 
	 * @param args
	 *            ALL_STRING,SERVICE_STRING,AUTH_STRING
	 */
	public static void start(String args) {
		if (Boot.args == null) {
			Boot.args = args == null ? ALL_STRING : args;
		}
		if (!Boot.ALL_STRING.equals(Boot.args)
				&& !Boot.SERVICE_STRING.equals(Boot.args) & !Boot.AUTH_STRING.equals(Boot.args)) {
